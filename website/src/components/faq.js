 ...
 * 5 structured categories covering all competition guidelines, operations & edge cases.
 */
export function renderFAQPage() {
  ...
  const categories = [
    ...
    },
    {
      titleKey: "faq.cat5",
      items: [
        { q: "faq.q5_1", a: "faq.a5_1" },
        { q: "faq.q5_2", a: "faq.a5_2" },
        { q: "faq.q5_3", a: "faq.a5_3" },
        { q: "faq.q5_4", a: "faq.a5_4" },
      ],
    },
  ];
  ...
  page.innerHTML = `
    <section class="section">
      <div class="container">
        <!-- Clean Header: Title only, standard decoration -->
