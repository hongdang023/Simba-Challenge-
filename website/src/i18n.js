...
const translations = {
  vi: {
    ...
    // Hero
    'hero.badge': '🎉 100% Cứ Nộp Đủ Là Có Quà!',
    ...
    'hero.description': 'Tạo một website cá nhân bằng Google Antigravity, tự tin giới thiệu bản thân và rinh ngay Tên Miền (Domain) chính chủ 1 năm!',
    'hero.deadline': 'Hạn nộp: 23:59, 06/09/2026',
    'hero.prize': 'Mỗi học sinh hoàn thành đủ yêu cầu nhận ngay 1 domain cá nhân trong 1 năm — Xịn xò như của các Mentor!',
    'hero.ctaPrimary': 'Làm Website trên Simba',
    'hero.ctaSecondary': 'Làm 4F Reflection',
    'hero.mentorTitle': 'Xem website & domain của các Mentor:',
    ...
    'howToJoin.subheading': 'Các bước làm bài trên Simba thì con đã quá quen thuộc rồi! Điểm mới mẻ duy nhất là chiếc video ngắn 60–90s để con tự tin khoe website của mình thôi!',
    ...
    'howToJoin.sub3Title': '3. Video Giới Thiệu (Mới & Thú vị!)',
    ...
    'rules.card3Title': '🏷️ 3. Tên miền (Domain)',
    ...
    'awards.everyoneTitle': '🎁 100% Cứ Tham Gia Hoàn Thành Là Có Quà!',
    ...
    'awards.extraTitle': '⭐ Quyền Lợi Đỉnh Chóp Cho Top 3',
  ...
  en: {
    ...
    // Hero
    'hero.badge': '🎉 100% Submission = Guaranteed Gift!',
    'hero.title': 'My Personal Website Challenge',
    ...
    'hero.prize': 'Every student who completes all requirements receives a 1-year personal domain — just like our Mentors!',
    ...
    'howToJoin.sub3Title': '3. Short Video (New & Fun!)',
    ...
    'rules.card3Title': '🏷️ 3. Domain Wishlist',
    ...
    'awards.everyoneTitle': '🎁 100% Submission = Guaranteed Gifts!',
