...
const translations = {
  vi: {
    ...
    'rules.card3_3': 'Sau khi bài làm đạt chất lượng và được mentor duyệt, con tự tiến hành đăng ký mua trên Cloudflare để sở hữu chính chủ (BTC sẽ chuyển khoản hoàn lại chi phí mua domain).',
  ...
  en: {
    ...
    'rules.card3_3': 'Once your project meets quality standards and is approved by mentors, register the domain on Cloudflare for 100% personal ownership (Organizer will reimburse the domain cost).',
    'rules.card4Title': '4. Video & Reflection',
