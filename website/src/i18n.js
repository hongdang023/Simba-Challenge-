...
const translations = {
  vi: {
    ...
    'rules.card3_2': 'Giải thích ngắn gọn lý do con chọn tên miền đó trong bài nộp.',
    'rules.card3_3': 'Sau khi bài làm đạt chất lượng và được mentor duyệt, con tự tiến hành đăng ký mua trên Cloudflare để sở hữu chính chủ (BTC sẽ chuyển khoản hoàn lại $10–$15 chi phí mua domain).',
  ...
  en: {
    ...
    'rules.card3_2': 'Briefly explain why you chose that domain name in your submission.',
    'rules.card3_3': 'Once your project meets quality standards and is approved by mentors, register the domain on Cloudflare for 100% personal ownership (Organizer will reimburse the $10–$15 domain cost).',
    'rules.card4Title': '4. Video & Reflection',
