...
const translations = {
  vi: {
    ...
    'faq.q1_2': 'Con có được sửa bài sau các Checkpoint không, và mentor sẽ chấm bản nào?',
    ...
    'faq.a1_3': 'Có. Con vẫn được nộp bản cuối đúng hạn 06/09/2026. Tuy nhiên, con sẽ không nhận được feedback nâng cấp từ mentor ở các vòng trước.',
    'faq.q1_4': 'Nếu sau khi nộp mà link website gặp sự cố kỹ thuật thì xử lý thế nào?',
    'faq.a1_4': 'Con nên chụp ảnh màn hình bằng chứng deploy thành công khi nộp bài. Mentor sẽ kiểm tra lại link trong ngày 07/09 và đối chiếu bản deploy ổn định của con.',

    'faq.cat2': '2. Mua Domain & Hoàn tiền',
    'faq.q2_1': 'Điều kiện để được hoàn tiền mua domain cá nhân là gì?',
    'faq.a2_1': 'Con cần đáp ứng 2 điều kiện: (1) Đạt chất lượng và được mentor duyệt ở Checkpoint 2 (ngày 04/09); (2) Tự mua domain chính chủ đuôi .com trên Cloudflare và lưu lại ảnh/hóa đơn thanh toán. BTC sẽ chuyển khoản hoàn lại $10.46 (270.000 VNĐ).',
    'faq.q2_2': 'Nếu domain mong muốn bị người khác mua mất hoặc tăng giá thì sao?',
    'faq.a2_2': 'Đó là lý do con cần chuẩn bị trước 1 domain chính + 1 domain dự phòng (đuôi .com) và kiểm tra trên Cloudflare. Con chỉ tiến hành mua sau khi mentor duyệt để đảm bảo domain khả dụng và đúng mức tài trợ.',
    'faq.q2_3': 'Tài khoản domain thuộc sở hữu của ai và nhận hoàn tiền khi nào?',
    'faq.a2_3': 'Tài khoản Cloudflare và domain thuộc sở hữu chính chủ 100% của học sinh/gia đình. BTC sẽ chuyển khoản hoàn tiền vào ngày 08/09/2026 sau khi con gửi bằng chứng thanh toán.',
    ...
    'faq.a3_2': 'Không. Điểm AI trên Simba chỉ mang tính chất tham khảo tức thì để con tự rà soát. Kết quả chính thức hoàn toàn do Hội đồng Mentor đánh giá dựa trên rubric và sản phẩm thực tế.',
    ...
    'faq.a5_1': 'Video cần có mặt thật, giọng nói thật của con và quay màn hình website. Video đăng tải lên Google Drive của cuộc thi và đặt tên theo cú pháp: [Tên học sinh]_[Tên domain].',
    'faq.q5_2': 'Hình ảnh và nội dung sử dụng trên website cần tuân thủ quy định gì?',
    'faq.a5_2': 'Khuyến khích dùng hình ảnh cá nhân, gia đình hoặc sản phẩm tự làm. Nếu dùng hình ảnh hoặc nhạc từ Internet, con cần ghi rõ nguồn và tuyệt đối không sử dụng nội dung nhạy cảm.',
    'faq.q5_3': 'Thông tin và hình ảnh của con có được bảo vệ quyền riêng tư không?',
    ...
    'faq.q5_4': 'Ba mẹ có thể hỗ trợ con những phần việc nào trong suốt cuộc thi?',
